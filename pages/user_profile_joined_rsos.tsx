...
const UserProfileJoinedRSOs: React.FC = () => {
  return (
    <>
      ...
      <div style={{ paddingTop: '100px', paddingBottom: '40px' }}>
          <h1 className="text-5xl md:text-7xl sm:text-7xl font-bold" style={{ color: 'rgb(19, 41, 75)' }}>User Profile</h1>
        </div>
        ...
        {/* Placeholder for the announcemetns section */}
          <div className="w-full p-4">
            <div style={{ backgroundColor: 'white' }} className="p-4 rounded-md shadow-md">
              <h2 style={{ color: 'rgb(19, 41, 75)' }} className="text-1xl md:text-2xl sm:text-2xl font-semibold mb-2">RSO NAME</h2>
...
export default UserProfileJoinedRSOs;